...
import classes from "./multiple-scattering.module.css";
...
const BoxesPage = dynamic(
  () => import('../components/threejs/test'), { ssr: false });
  ...
  {loading && <LoadingPrompt/>}
    <div className={classes.page} key={loadingData? "wait" : "ready"}>
      ...
      <div className={classes.runMultem}>
        <div /* onClick={RunMultemHandler} */><i class="fa fa-lock" aria-hidden="true"/> RUN MULTEM</div>
